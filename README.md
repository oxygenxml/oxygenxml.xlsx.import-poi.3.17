# Excel XLSX Libraries v3.17 Add-on
...
2. Enter or paste https://raw.githubusercontent.com/oxygenxml/oxygenxml.xlsx.import-poi.3.17/master/addon.xml in the **Show add-ons from** field or select it from the drop-down menu.
